let action = new Creep.Action('squadInvading');
module.exports = action;
action.isValidAction = function(creep){
  return false;
  return FlagDir.hasSquadInvasionFlag();
};
action.isAddableAction = function(){ return false; };
action.isAddableTarget = function(){ return false; };
...
action.newTarget = function(creep){
    ...
    var flag = FlagDir.find(FLAG_COLOR.squadInvade, creep.pos);

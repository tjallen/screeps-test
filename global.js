...
mod.FLAG_COLOR = {
    ...
    army: {
      squad: {
        ...
        filter: {'color': COLOR_BLUE, 'secondaryColor': COLOR_ORANGE }
      },
      squadInvade: {
        color: COLOR_BLUE,
        secondaryColor: COLOR_RED,
        filter: {'color': COLOR_BLUE, 'secondaryColor': COLOR_RED }
      },
      squadRally: {
        color: COLOR_BLUE,
        secondaryColor: COLOR_YELLOW,
        filter: {'color': COLOR_BLUE, 'secondaryColor': COLOR_YELLOW }
      },
    },

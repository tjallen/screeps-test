...
global.install = () => {
    ...
    _.assign(Creep, {
        action: {
            ...
            following: load("creep.action.following"), 
            ...
            staging: load("creep.action.staging"),
            squadInvading: load("creep.action.squadInvading"),
...
module.exports.loop = function () {
    ...
    if ( Game.time % SPAWN_INTERVAL === 0 ) {
      var squads = Object.keys(Memory.army);
      squads.forEach((s) => {
        Army.reinforceSquad(s);
      });
    }
